...
export default function RecipeFinder() {
  ...
  return (
    <section id="recipe-finder" className="py-24 bg-brand-cream-50 text-stone-900 border-t border-stone-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-4 bg-white p-6 sm:p-8 rounded-3xl border border-stone-200 shadow-md space-y-6">
                  ...
                  <button
                    ...
                    className={`left-align w-full text-left p-3 rounded-xl border font-medium text-xs sm:text-sm transition-all cursor-pointer flex items-center justify-between ${
                      isSelected
                        ...
                        : "bg-stone-50 border-stone-150 text-stone-600 hover:bg-stone-100 hover:border-stone-250"
                    }`}
                  >
          ...
          <div className="lg:col-span-8 space-y-6">
            <div className="flex justify-between items-center bg-stone-100/60 p-4 rounded-xl border border-stone-150">
              ...
              {matchedRecipes.map((recipe) => {
                ...
                return (
                  <div
                    ...
                    className={`p-6 sm:p-8 bg-white rounded-3xl border shadow-md transition-all ${
                  ...
                  >
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-stone-100 pb-4">
                      ...
                      <div className="space-y-1 text-left">
                        ...
                        <h4 className="font-display font-black text-xl tracking-tight text-stone-900 leading-snug">
                          {recipe.title}
                        </h4>
                      </div>
                              ...
                              <span
                                ...
                                className={`px-2.5 py-1 text-xs rounded-lg font-medium border flex items-center space-x-1.5 ${
                                  hasItem
                                    ...
                                    : "bg-stone-50 border-stone-200 text-stone-400 font-light"
                                }`}
                              >
                                {hasItem ? "✅" : "❌"}
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="flex flex-wrap gap-1">
                          {recipe.otherIngredients.map((item) => (
                            <span
                              key={item}
                              className="px-2.5 py-1 text-xs bg-stone-50 text-stone-605 border border-stone-150 rounded-lg capitalize"
                            >
                              + {item}
                            </span>
                          ))}
                    ...
                    <div className="space-y-3.5 bg-stone-50 p-5 rounded-2xl border border-stone-200/50 text-left">
                      <span className="text-xs font-mono text-stone-450 block uppercase tracking-wider font-bold">
                        PREPARATION INSTRUCTIONS
                      </span>
                      <ol className="list-decimal pl-5 text-stone-700 space-y-2 text-xs sm:text-sm font-light leading-relaxed">
