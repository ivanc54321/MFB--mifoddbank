...
export const MEMBER_FOOD_BANKS: MemberFoodBank[] = [
  {
    ...
    hqCity: "Detroit",
    regionServed: "Southeast Michigan",
    countiesCovered: ["Wayne", "Oakland", "Macomb", "Livingston", "Monroe"],
    description: "Since 1977, Gleaners has been providing households and partner agencies in Southeast Michigan with nutritious food and supporting educational resources.",
    website: "https://www.gcfb.org",
    phone: "(866) 453-2637",
    mealsDistributedMillions: 48.5,
    householdsServedAnnually: 220000,
    colorHex: "#1E3F20", // Deep brand green
  },
  {
    id: "forgotten-harvest",
    name: "Forgotten Harvest",
    hqCity: "Oak Park",
    regionServed: "Metro Detroit",
    countiesCovered: ["Wayne", "Oakland", "Macomb"],
    description: "Forgotten Harvest rescues surplus foods from grocery stores, distributors, and farms, delivering they directly to local emergency pantries and food providers.",
    website: "https://www.forgottenharvest.org",
    phone: "(248) 967-1500",
    mealsDistributedMillions: 42.0,
    householdsServedAnnually: 180000,
    colorHex: "#c95d41", // Warm brand secondary
  },
  {
    id: "gm-west",
    name: "Feeding America West Michigan",
    hqCity: "Comstock Park",
    regionServed: "West Michigan & Upper Peninsula",
    countiesCovered: ["Kent", "Ottawa", "Muskegon", "Allegan", "Marquette", "Chippewa", "Traverse", "Kalamazoo", "Berrien", "Van Buren", "Mason", "Wexford", "Delta"],
    description: "Serving 40 counties across West Michigan and the Upper Peninsula, Feeding America West Michigan distributes millions of pounds of food through mobile food pantries and partner networks.",
    website: "https://www.feedwm.org",
    phone: "(616) 784-3250",
    mealsDistributedMillions: 31.2,
    householdsServedAnnually: 155000,
    colorHex: "#e07a5f",
  },
  {
    id: "greater-lansing",
    ...
    hqCity: "Lansing",
    regionServed: "Mid-Michigan",
    countiesCovered: ["Ingham", "Eaton", "Clinton", "Shiawassee", "Gratiot", "Clare", "Isabella"],
    description: "Greater Lansing Food Bank coordinates hunger relief across central Michigan, supporting pantries, community gardens, and emergency mobile trucks in Ingham, Clinton, Eaton, and surrounding counties.",
    website: "https://glfoodbank.org",
    phone: "(517) 853-7800",
    mealsDistributedMillions: 12.5,
    householdsServedAnnually: 65000,
    colorHex: "#2d5a27",
  },
  {
    id: "south-michigan",
    ...
    hqCity: "Battle Creek",
    regionServed: "South Central Michigan",
    countiesCovered: ["Calhoun", "Jackson", "Kalamazoo", "Hillsdale", "Branched", "St. Joseph", "Barry", "Lenawee"],
    description: "Dedicated to enhancing food security in South Central Michigan, this food bank coordinates meal distributions, backpacks for children, and senior nutrition hampers.",
    website: "https://smfoodbank.org",
    phone: "(269) 964-3663",
    mealsDistributedMillions: 15.0,
    householdsServedAnnually: 78000,
    colorHex: "#b45309",
  },
  {
    id: "eastern-michigan",
    ...
    hqCity: "Flint",
    regionServed: "Northeast & Thumb Michigan",
    countiesCovered: ["Genesee", "Saginaw", "Lapeer", "St. Clair", "Sanilac", "Tuscola", "Huron", "Bay", "Midland", "Alpena", "Presque Isle", "Cheboygan"],
    description: "FBEM supports over 700 partner agencies in 22 eastern Michigan counties, pioneering emergency water relief and hunger services in Flint and northern communities.",
    website: "https://www.fbem.org",
    phone: "(810) 239-4441",
    mealsDistributedMillions: 28.6,
    householdsServedAnnually: 130000,
    colorHex: "#155e75",
  },
  {
    id: "manna-project",
    name: "Manna Food Project",
    hqCity: "Harbor Springs",
    regionServed: "Northern Lower Michigan",
    countiesCovered: ["Emmet", "Charlevoix", "Antrim"],
    description: "Manna is a grassroots food rescue and pantry clearinghouse feeding hungry families in the northernmost counties of lower Michigan since 1989.",
    website: "https://www.mannafoodproject.org",
    phone: "(231) 347-8852",
    mealsDistributedMillions: 3.2,
    householdsServedAnnually: 180000,
    colorHex: "#0369a1",
  }
];
...
export const VOLUNTEER_ROLES: VolunteerRole[] = [
  ...
  },
  {
    ...
    impactDescription: "Mobile pantries serve 200+ local families in a single morning, removing transportation barriers for rural Michiganders.",
    spotsRemaining: 8,
...
export const BLOG_POSTS: BlogPost[] = [
  {
    id: "1",
    title: "Michigan Farm to Family: Harnessing the Summer Harvest",
    excerpt: "How a new collaboration between local Michigan cherry growers and the Food Bank Council is bringing thousands of pounds of fresh fruit to rural pantries.",
    category: "News",
    readTime: "4 min read",
    date: "May 18, 2026",
    ...
    content: "Our state has an abundance of agricultural richness, yet food insecurity persists in both urban clusters and scenic rural counties. In a groundbreaking joint effort, Michigan cherry and apple farmers are pledging surplus seasonal products directly to member food banks. Instead of allowing valuable crops to go unused due to supply-chain friction, regional pantries are routing refrigerated trucks directly to farm docks. The result? Over 45,000 pounds of pristine, vitamin-rich fruit distributed to Michigan households in the past month alone. Read on to learn how this model is scaling up for the autumn harvest.",
    likes: 34,
    commentsCount: 3,
    tags: ["Farming", "Fresh Produce", "Michigan Agriculture"]
  },
  {
    id: "2",
  ...
  {
    id: "4",
    title: "Upgrading Michigan's Food Security Infrastructure: Cold Storage Expansion",
    ...
    content: "The bottleneck in fresh food distributions has never been supply—it is spoilage. Perishable agricultural items like dairy, milk, fresh meat, and raw leafy greens demand unbroken temperature controls. We are ecstatic to announce a massive $3.2M infrastructure upgrade funding energy-efficient cold vaults and walk-in refrigerators across 18 high-need local pantry warehouses in Michigan. This vital advancement will dramatically minimize food waste, allowing member agencies to store fresh items up to three times longer.",
    likes: 21,
    commentsCount: 1,
